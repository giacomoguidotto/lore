...
Mneme is Giacomo's canonical personal context repository.

Use Mneme only when the task depends on Giacomo's durable personal context, preferences, history, current state, or ongoing projects. Do not load Mneme by default.

When Mneme is relevant:
