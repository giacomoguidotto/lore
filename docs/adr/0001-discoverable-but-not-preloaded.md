...
External agents should search Notion first when they need Giacomo's durable personal context. They should consult Lore only when they need repo-local policy, Notion export/schema infrastructure, migration or historical support records, generated context packs, or a local fallback when Notion is unavailable.
